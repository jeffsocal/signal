...
svmt <- function(v_features,
  ...
  svm_model                   <- svm(d_train[,v_features], d_train[,c_predict], type=type, kernel=kernel, scale=FALSE)
  predict_model               <- predict(svm_model, newdata=d_test[,v_features])
...
svm_models <- function(){
  ...
  l_models <- list()
  l_models[['svm01']] <- function(...) svmt(..., type='eps-regression', kernel='linear')
  l_models[['svm02']] <- function(...) svmt(..., type='eps-regression', kernel='radial')
  l_models[['svm03']] <- function(...) svmt(..., type='eps-regression', kernel='polynomial')
  l_models[['svm04']] <- function(...) svmt(..., type='nu-regression', kernel='linear')
  l_models[['svm05']] <- function(...) svmt(..., type='nu-regression', kernel='radial')
  l_models[['svm06']] <- function(...) svmt(..., type='nu-regression', kernel='polynomial')
